...
See the [datasets](datasets.qmd) page for the data and [below](#submission) for submission details.
...
We've put together an [example dashboard](example_project/example_project.qmd) which you're welcome to start from. [Download the code](example_project.zip) to have a look at our example. You can also see a gallery of examples on [Quarto's website](https://quarto.org/docs/gallery/#dashboards).
